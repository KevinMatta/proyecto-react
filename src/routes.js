...
const Impuestos = React.lazy(() => import('./views/pantallas/impuestos prod/impuestos prod'))
...
const routes = [
  ...
  { path: '/pantallas/impuestos prod', name: 'Impuestos Prod', element: Impuestos },
  ...
  { path: '/pantallas/máquinas', name: 'Importaciones', element: Maquinas },
  ...
  { path: '/pantallas/oficios y profesioness', name: 'Oficios y Profesiones', element: Oficios },
